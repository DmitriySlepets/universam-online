...
<footer id="rt-footer-surround">
	<div id="left-right-footer">
		...
		<ul style="margin: 0;width: auto;display: inline-block;">
			<li><a href="/kontakty/">Сообщить об ошибке</a></li>
			<li><a href="/not_paid/">Экономия 100%</a></li>
...
<div class="mobile-footer mobile-show" style="height: 100%;padding-top: 20px;">
	...
	<a href="/kontakty/" style="line-height: 30px;display:block; width:100%; color: #000;font-weight:100;">Сообщить об ошибке</a>
	<a href="/not_paid/" style="line-height: 30px;display:block; width:100%; color: #000;font-weight:100;">Экономия 100%</a>
	<a href="/usloviya-zakaza/" style="line-height: 30px;display:block; width:100%; color: #000;font-weight:100;">Условия заказа</a>
    <a href="/politika-konfidentsialnosti/" style="line-height: 30px;display:block; width:100%; color: #000;font-weight:100;">Политика Конфиденциальности</a>
	<a href="/kontakty/" style="line-height: 30px;display:block; width:100%; color: #000;font-weight:100;">Контакты</a>
</div>
<?php wp_footer(); ?>
...
<!-- script proverka bota -->
<a href="//clickfrog.ru/?page=registration&amp;referrer_id=27304">
...
<script type="text/javascript">
    var clickfrogru_uidh='cdb25d4c8862a4d88c51f3d50487f046';
</script>
